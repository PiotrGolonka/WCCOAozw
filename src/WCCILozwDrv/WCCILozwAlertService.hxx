#ifndef WCCILozwALERTSERVICE_H_
#define WCCILozwALERTSERVICE_H_
...
class WCCILozwAlertService : public AlertService
{
  public:

    /// Constructor
    WCCILozwAlertService();

    /// Destruktur
    virtual  ~WCCILozwAlertService();
