#ifndef WCCOAozwALERTSERVICE_H_
#define WCCOAozwALERTSERVICE_H_
...
class WCCOAozwAlertService : public AlertService
{
  public:

    /// Constructor
    WCCOAozwAlertService();

    /// Destruktur
    virtual  ~WCCOAozwAlertService();
