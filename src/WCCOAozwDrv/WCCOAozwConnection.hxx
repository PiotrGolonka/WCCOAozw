// WCCOAozwConnection.hxx -- WCCOAozw HmiConnection-Class


#ifndef _WCCOAozwCONNECTION_H_
#define _WCCOAozwCONNECTION_H_

#include <HmiConnection.hxx>

class WCCOAozwConnection : public HmiConnection
{
  public:
     
    WCCOAozwConnection(DpIdType id);
