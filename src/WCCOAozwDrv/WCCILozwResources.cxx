...
unsigned short int WCCILozwResources::tcpPort = 12401;

//-------------------------------------------------------------------------------
// init is a wrapper around begin, readSection and end

void WCCILozwResources::init(int &argc, char *argv[])
{
...
PVSSboolean WCCILozwResources::readSection()
{
  // Are we in our section ?
  if ( !isSection("WCCILozw") ) return PVSS_FALSE;
...
int WCCILozwResources::getNumberOfDpNames()
{
